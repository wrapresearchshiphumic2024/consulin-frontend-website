...
export default function DetailList() {
  return (
    <div className="p-6">
      <h1 className="text-5xl font-bold text-left text-[#1E0342] mb-3">Detail Psikologist</h1>
      <p className="text-left text-[#1E034280] text-semibold mb-8">View psychologist details on this page</p>
