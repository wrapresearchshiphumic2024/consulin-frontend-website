...
export default function ApprovePsychologist() {
  ...
  return (
    <div className="p-6">
      <h1 className="text-3xl font-bold text-left mb-2 text-[#1E0342]">Approve Psychologist</h1>
      <p className="text-left text-[#1E034280] mb-8">Review and manage psychologist who just registered</p>
            ...
            <div className="flex justify-between w-full px-4">
                ...
                <AlertDialogContent>
                    ...
                    <AlertDialogFooter>
                        <AlertDialog>
                        <AlertDialogTrigger asChild>
                        <Button className="bg-green-500 text-white px-6 py-2 rounded-full">Confirm</Button>
                        </AlertDialogTrigger>
                        <AlertDialogContent>
                            <AlertDialogHeader>
                    ...
                    <AlertDialogAction className="bg-white text-black px-6 py-2 rounded-full">Cancel</AlertDialogAction>
                    </AlertDialogFooter>
                </AlertDialogContent>
            </AlertDialog>
            <AlertDialog>
