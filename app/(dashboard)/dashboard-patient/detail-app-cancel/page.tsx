    ...
    <>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-10">
        <div className="bg-white rounded-2xl shadow-lg">
          <div className="w-full bg-red-500 pt-4 rounded-t-2xl text-white text-center py-2 font-bold text-lg h-[60px]">
            Canceled
          </div>
        ...
        <div className="flex flex-col space-y-6">
          ...
          <div className="bg-white p-6 rounded-2xl shadow-lg font-semibold h-[220px]">
            ...
            <p className="mt-2 text-[#1E0342]">
              I am unable to attend this session due to my health condition.
            </p>
          </div>
        </div>
      </div>
